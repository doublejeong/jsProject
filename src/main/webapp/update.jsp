		...
		<div class="row">
			<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>">
				<table class="table table-striped" style="text-align: center; botder: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">掲示板の修正</th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<input type="submit" class="btn btn-primary pull-right" value="修整">
			</form>
		</div>
	</div>
